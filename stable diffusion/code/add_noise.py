...
img = Image.open(r"C:\Users\aanch\OneDrive\Documents\Desktop\stable diffusion\images\dog.jpg")
...
output_img = Image.fromarray(noise_imgs[3].squeeze(0).numpy(), 'RGB')
output_img.save(r"C:\Users\aanch\OneDrive\Documents\Desktop\stable diffusion\images\output.jpg")
